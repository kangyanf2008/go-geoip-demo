...
A trace.Info provides tracing for short-lived objects, usually requests.
...
// DebugUseAfterFinish controls whether to debug uses of Info values after finishing.
...
var contextKey = contextKeyT("golang.org/x/net/trace.Info")

// NewContext returns a copy of the parent context
// and associates it with a Info.
func NewContext(ctx context.Context, tr Trace) context.Context {
	return context.WithValue(ctx, contextKey, tr)
}

// FromContext returns the Info bound to the context, if any.
func FromContext(ctx context.Context) (tr Trace, ok bool) {
	tr, ok = ctx.Value(contextKey).(Trace)
	return
}

// Info represents an active request.
...
// New returns a new Info with the specified family and title.
...
func (tr *trace) addEvent(x interface{}, recyclable, sensitive bool) {
	...
	/*
		...
		a trace.Info after its Finish method is called.
